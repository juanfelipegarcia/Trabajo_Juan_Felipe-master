...
<body >
     <div class="container">
          ...
          <br>
          <form class="form-signin" action="../Controlador/ControladorEstado.php" method="post" id="FrmEditarEstado" name="FrmEditarEstado" align-items: "center">
               <div class="form-row" >
                    <div class="form-group col-md-3">
                         <label for="">Estado N°</label>
                         <input type="text" class="form-control" name="IdEstado" id="IdEstado" value="<?php echo $Estado->getIdEstado();?>" readonly>
                    </div>
               </div>
               ...
               <br>
               <div align="center">
               <button  type="" class="btn btn-primary"><a href="ListarEstado.php"><font color="#ffffff">Volver</font></a></button>
               </div>
